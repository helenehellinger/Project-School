...
public class ListViewAdapterFolders extends BaseAdapter {
    ...
    public ListViewAdapterFolders(Activity activity) {
        // TODO Auto-generated constructor stub
        this.activity = activity;
        data = InterDatabase.getDataArray(activity, "folders");
